...
from inference.analytic_inference import analytic_inference_W, analytic_inference_predict, MFVI_W, MFVI_predict
...
def main_inference():
    ...
    train_set, _, pool_set = make_random_balanced_split(train_dataset, train_per_class=2, val_size=100)
    ...
    print(f'Starting on calculating RSME for analytic inference')
    RSMEs = record_RSME_AL_inference(al_iterations, data_transfer_amount, analytic_inference_W, analytic_inference_predict, train_set,
    ...
    RSMEs = record_RSME_AL_inference(al_iterations, data_transfer_amount, MFVI_W, MFVI_predict, train_set,
                                     pool_set, test_loader, device, data_var=1.0, prior_var=1.0)
