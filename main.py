...
from novel_contribution.alleatoric_mnist import main_novel_contribution_alleatoric_data
from novel_contribution.main_novel_contribution import main_novel_contribution
from reproduction.figures_reproduction import bayesian_acc_curves, bayesian_acc_table, bayesian_vs_deterministic_curves
from reproduction.main import main_reproduction
...
# This block implements my novel contribution: Run main_novel_contribution to compute and store accuracy data of
# my novel method. acc_curves_novel_contribution then uses this accuracy curve, as well as those computed by
# main_reproduction, to display results.
